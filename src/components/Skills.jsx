  ...
  return (
    <div className="w-full">
      ...
      <div className="animate-on-scroll flex text-center justify-center items-center p-2 gap-12 flex-wrap my-12 md:max-w-6xl mx-auto ">
        {skills.map((skill) => (
          <div
            className="text-secondaryTextColor flex flex-col items-center gap-x-4 border-2 w-32 md:w-48 p-4 rounded-md border-hoverBg hover:scale-105 transition-all duration-300 ease-in-out hover:bg-secondaryBg/10"
            key={skill.id}
          >
